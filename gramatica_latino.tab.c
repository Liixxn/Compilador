...
/* Line 214 of yacc.c  */
#line 161 "gramatica_latino.tab.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 173 "gramatica_latino.tab.c"
...
static const yytype_int8 yyrhs[] =
{
      ...
      17,    -1,    20,    -1,    11,     5,    18,    -1,    18,     3,
      19,    -1,    18,     4,    19,    -1,    19,    -1,    11,    -1,
       9,    -1,    10,    -1,    12,    -1,     8,     6,    18,     7,
      -1
};
...
{
       0,    73,    73,    82,    83,    91,    92,    99,   148,   165,
     181,   192,   217,   228,   237,   250
};
#endif
...
{
       1,     7,     9,    15,     1,   -10,   -10,   -10,    -4,    -4,
     -10,   -10,   -10,   -10,   -10,   -10,    -3,   -10,    -1,    -4,
      -4,   -10,   -10,   -10
};
...
{
      19,    20,    19,    20,    21,    12,    13,    14,    15,     1,
      22,    23,     2,     8,     9,    10,    11,    18
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     3,     4,     7,     9,    10,    11,    12,     8,
      19,    20,    11,     6,     5,     0,     4,     9
};
...
{
       0,     8,    11,    14,    15,    16,    17,    20,     6,     5,
       0,    16,     9,    10,    11,    12,    18,    19,    18,     3,
       4,     7,    19,    19
};
...
#line 192 "gramatica_latino.y"
    {
        ...
        if(buscarTabla(indice, (yyvsp[(1) - (1)].stringVal), tabla) != -1){     //En este IF entra si buscarTabla devuelve la posicion
            ...
            //Para si es de tipo texto
                ...
                (yyval.tr).n = crearVariableTerminalString(tabla[pos].texto, tabla[pos].registro); //Creamos un nodo terminal con las cadenas{
...
#line 217 "gramatica_latino.y"
    {
        ...
        (yyval.tr).n = crearNodoTerminal((yyvsp[(1) - (1)].enteroVal), tipos[1]); 
...
/* Line 1464 of yacc.c  */
#line 1576 "gramatica_latino.tab.c"
      default: break;
    }
